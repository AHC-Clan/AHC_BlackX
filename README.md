...
├── Build_BlackX.bat          # DLL 빌드 스크립트
├── Build_KeyGen.bat          # 키 갱신 도구 (Manual / Auto)
├── Git_Manager.bat           # Git 커밋/푸시 관리 도구
│
├── addons/
│   ├── AHC_BlackX.dll        # 빌드된 DLL (Build_BlackX.bat으로 생성)
...
- 키가 외부에 노출될 경우 `Build_KeyGen.bat`으로 즉시 교체하세요.
